...
void PanelListPanel::PerformLayout()
{
	...
	m_pPanelEmbedded->SetSize( wide - /*scrollBarWidth*/m_vbar->GetWide(), vpixels );	// scrollbar will sit on top (zpos set explicitly)
	...
	int iColumnWidth = ( wide - xpos - /*scrollBarWidth*/m_vbar->GetWide() - 12 ) / m_iNumColumns;
